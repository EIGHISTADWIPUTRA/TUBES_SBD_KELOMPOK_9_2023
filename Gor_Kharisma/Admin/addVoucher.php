...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (addVoucher($conn, $nama_voucher, $deskripsi_voucher, $tanggal_berlaku, $besar_diskon, $stok,$code_voucher)) {
        echo "
        <script>
    ...
    <div class="container mt-5">
        ...
        <form action="addVoucher.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="code_voucher" name="code_voucher" required>
            </div>
